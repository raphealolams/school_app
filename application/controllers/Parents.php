...
class Parents extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->session->userdata('parent_login') == 1)
            redirect(base_url() . 'index.php?parents/noticeboard', 'refresh');
    }
    ...
    function dashboard()
    {
        ...
        $page_data['info']  = $this->db->get_where('parent', array(
    ...
    function marks($param1 = '')
    {
        ...
        $page_data['term_id']    = $term;
        $page_data['card_pin'] = $card_pin;
        $page_data['card_serial'] = $card_serial;

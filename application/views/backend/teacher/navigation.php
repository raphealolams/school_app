    ...
    <ul id="main-menu" class="">
        ...
        ?> ">
            <a href="#">
                ...
                <span><?php echo ucfirst(get_phrase('student')); ?></span>
            </a>
            <ul>
                ...
                <li class="<?php if ($page_name == 'student_information' || $page_name == 'student_marksheet') echo 'opened active'; ?> ">
                    <a href="#">
                        <span><i class="entypo-dot"></i> View Students</span>
                    </a>
                    <ul>
                        ...
                        ?>
                            <li class="<?php if ($page_name == 'student_information' && $class_id == $row['class_id']) echo 'active'; ?>">
                                <a href="<?php echo base_url(); ?>index.php?<?php echo $account_type; ?>/student_information/<?php echo $row['class_id']; ?>">
                                    <span><?php echo ucfirst(get_phrase('class')); ?> <?php echo $row['name']; ?></span>
                                </a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
        ...
        <li class="<?php if ($page_name == 'teacher') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?<?php echo $account_type; ?>/teacher_list">
                ...
                <span><?php echo ucfirst(get_phrase('teacher')); ?></span>
            </a>
        </li>
        ...
        <li class="<?php if ($page_name == 'subject') echo 'opened active'; ?> ">
            <a href="#">
                ...
                <span><?php echo ucfirst(get_phrase('subject')); ?></span>
            </a>
            <ul>
<?php $classes = $this->db->get('class')->result_array();
foreach ($classes as $row):
...
?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'marks') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?<?php echo $account_type; ?>/reports">
                        <span><i class="entypo-dot"></i> Manage Reports</span>
                    </a>
                </li>
            </ul>
        </li>

...
<head>
	...
	<meta name="description" content="Meshable " />
...
<div class="login-container">
	...
	<div class="login-header login-caret">
		...
		<div class="login-content" style="width:100%;">
			...
			<a href="<?php echo base_url();?>" class="logo">
				<img src="uploads/logo2.png" height="60" alt="" />
			</a>
	...
	<script type="text/javascript" src="assets/js/neon-login.js"></script>
	<script type="text/javascript" src="assets/js/neon-custom.js"></script>

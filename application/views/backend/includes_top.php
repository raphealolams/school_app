<link rel="stylesheet" type="text/css" href="assets/js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css">
...
<?php
    ...
    <link rel="stylesheet" type="text/css" href="assets/css/skins/<?php echo $skin_colour;?>.css">

<?php endif;?>

<?php if ($text_align == 'right-to-left') : ?>
    <link rel="stylesheet" type="text/css" href="assets/css/neon-rtl.css">
<?php endif; ?>
...
<link rel="stylesheet" type="text/css" href="assets/css/font-icons/font-awesome/css/font-awesome.min.css">

<link rel="stylesheet" type="text/css" href="assets/js/vertical-timeline/css/component.css">
<link rel="stylesheet" type="text/css" href="assets/js/datatables/responsive/css/datatables.responsive.css">

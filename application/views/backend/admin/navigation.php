<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'sections') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/school_sections">
                <i class="entypo-gauge"></i>
        ...
        <!-- School Term -->
        <li class="<?php if ($page_name == 'school_term') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?admin/school_term">
                <i class="entypo-gauge"></i>

	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/term/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
						...
						<div class="col-sm-5">
							<select name="session_id" class="form-control select2">
                              ...
                              <?php 
								...
								foreach($session as $session_row):
									?>
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-default"><?php echo get_phrase('add_term');?></button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
